...
namespace Mongoose {
WebController::WebController(int gcDivisor_) : gcDivisor(gcDivisor_), counter(0), Controller() {}
...
Session &WebController::getSession(Request &request, Response &response) { return sessions.get(request, response); }
};
