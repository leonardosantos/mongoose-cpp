...
void WebSocket::appendData(string data_) { data += data_; }
...
Request &WebSocket::getRequest() { return request; }
...
void WebSocket::close() { closed = true; }

bool WebSocket::isClosed() { return closed; }
...
struct mg_connection *WebSocket::getConnection() { return connection; }
};
